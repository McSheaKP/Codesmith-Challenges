// In this challenge we are going to simulate an AJAX call to get information 
// from a server. This is not a real AJAX call, but the asynchonicity is similar.

// The function ajaxSimulate takes an id and a callback function as input. 
// Modify the function so that after the database array, it will set a timer that 
// will pass the element of database whose index matches id to the callback 
// function after 0 ms.
...
// Without changing anything else, copy-paste the console.log statement somewhere

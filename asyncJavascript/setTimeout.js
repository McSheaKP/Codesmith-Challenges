...
// Beneath that console log, set a timer (see setTimeout) that will log to the console 
// 'I am in the setTimeout callback function' after 600 ms.
...
function printtoConsole(){
    console.log('I am the setTimeout callback fucntion')
}

setTimeout(printtoConsole, 0)
